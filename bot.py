...
def handle_screenshot(msg, idx):
    ...
    # УНИКАЛЬНЫЕ callback_data для админа
...
def admin_panel(call):
    ...
    # ВСЕ КНОПКИ С УНИКАЛЬНЫМИ callback_data
    markup = InlineKeyboardMarkup(row_width=2)
    markup.add(
...
# ============================================================
# КНОПКА: ВЫБОР КНОПКИ ДЛЯ РЕДАКТИРОВАНИЯ
# ============================================================
...
def edit_welcome(call):
    ...
    bot.register_next_step_handler(msg, lambda m: set_welcome(m))
